...
if(isset($_POST['formconnect'])){
		$nameconnect = htmlspecialchars($_POST['cname']);
    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-6 col-10 bg-white p-5">
          <h1 class="mb-4">Connectez vous avant d'acceder a l'interface<br></h1>
          <form method="post">
		  	<?php
			if(isset($erreur))
			{
			...
			?>
            <div class="form-group"> <input type="text" name="cname" class="form-control" placeholder="Nom d'utilisateur" id="form9"> </div>
            <div class="form-group mb-3"> <input type="password" name="pass" class="form-control" placeholder="Mot de passe" id="form10"> </div>
